...
javac -cp ".;./lib/sphinx4-core-5prealpha.jar.;./lib/sphinx4-data-1.0.0.jar.;./lib/mysql-connector-java-8.0.26.jar" --module-path 'C:\javafx-sdk-17.0.1\lib' --add-modules javafx.controls,javafx.fxml,javafx.media ./Main.java
Execute:
